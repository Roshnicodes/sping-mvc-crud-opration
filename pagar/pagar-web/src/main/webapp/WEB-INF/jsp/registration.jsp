...
<body>
    ...
    <form:form method="POST" action="userRegistration.do" modelAttribute="Registration">
        ...
        <!--    <td><div class="form-control">
          ...
          <tr>
            <td><div class="form-control">
                <form:errors path="mobileNumber"  class="label error-label"></form:errors>
                <label>
                  <p>
                    Mobile Number<small class="required">*</small>
                  </p> <form:input path="mobileNumber" class="inputControl" placeholder="Mobile Number" required="autofocus"
                     /> </label>
              </div>
            </td>
